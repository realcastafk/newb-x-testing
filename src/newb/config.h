...
#define NL_GAMMA 1.26                  // 0.3 low ~ 2.0 high
...
#define NL_TORCHLIGHT_INTENSITY 1.9  // 0.5 weak ~ 3.0 bright
...
#define NL_DAWN_SUNLIGHT_COL   vec3(1.0,0.65,0.2)
#define NL_NOON_SUNLIGHT_COL   vec3(1.0,0.75,0.57)
#define NL_NIGHT_MOONLIGHT_COL vec3(1.0,1.0,0.85)

/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(1.0,0.65,0.2)
#define NL_UNDERWATER_TORCH_COL vec3(1.0,0.65,0.2)
#define NL_NETHER_TORCH_COL     vec3(1.0,0.65,0.2)
#define NL_END_TORCH_COL        vec3(1.0,0.65,0.2)
...
#define NL_DAWN_ZENITH_COL   vec3(1.0,0.65,0.2)
#define NL_DAWN_HORIZON_COL  vec3(1.0,0.65,0.2)
#define NL_DAWN_EDGE_COL     vec3(1.0,0.65,0.2)
#define NL_DAY_ZENITH_COL    vec3(0.0,1.0,1.0)
#define NL_DAY_HORIZON_COL   vec3(1.0,1.0,1.0)
#define NL_DAY_EDGE_COL      vec3(0.2,0.7,1.0)
#define NL_NIGHT_ZENITH_COL  vec3(0.008,0.048,0.08)
#define NL_NIGHT_HORIZON_COL vec3(0.0,0.0,0.1)
...
#define NL_END_ZENITH_COL    vec3(1.0,0.4,0.0)
#define NL_END_HORIZON_COL   vec3(1.0,0.4,0.0)
...
#define NL_WAVE_SPEED 3.4      // 0.5 slow wave ~ 5.0 very fast wave
...
#define NL_WATER_TINT vec3(0.0,0.65,0.8)
...
#define NL_ENTITY_EDGE_HIGHLIGHT 0.37 // [toggle] 0.0 no highlight ~ 1.6 bright highlight
