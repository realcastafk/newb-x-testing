...
/* Lighting */
#define NL_SUNLIGHT_INTENSITY   2.5  // 1.0 weak ~ 5.0 bright
...
#define NL_NOON_SUNLIGHT_COL   vec3(1.0,0.6,0.25)
#define NL_NIGHT_MOONLIGHT_COL vec3(0.01,0.03,0.2)

/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(1.0,0.45,0.08)
#define NL_UNDERWATER_TORCH_COL vec3(1.0,0.45,0.08)
#define NL_NETHER_TORCH_COL     vec3(1.0,0.35,0.05)
#define NL_END_TORCH_COL        vec3(1.0,0.45,0.08)
...
#define NL_DAY_ZENITH_COL    vec3(0.2,1.1,1.7)
#define NL_DAY_HORIZON_COL   vec3(1.1,1.7,1.9)
#define NL_DAY_EDGE_COL      vec3(1.55,1.65,1.68)
...
#define NL_WAVE_SPEED 3.2      // 0.5 slow wave ~ 5.0 very fast wave
...
/* Water */
#define NL_WATER_TRANSPARENCY 0.85 // 0.0 transparent ~ 1.0 normal
#define NL_WATER_BUMP 0.06        // 0.001 plain ~ 0.2 bumpy water
#define NL_WATER_WAVE_SPEED  0.5  // 0.2 calm ~ 2.0 turbulent
#define NL_WATER_TEX_OPACITY 0.15  // 0.0 plain water ~ 1.0 vanilla water texture
#define NL_WATER_WAVE             // [toggle] wave effect
//#define NL_WATER_REFL_MASK      // [toggle] fake water reflection mask
#define NL_WATER_TINT vec3(0.25,0.65,0.95)
...
#define NL_CLOUD0_THICKNESS 3.2      // 0.5 slim ~ 8.0 fat
...
#define NL_ENTITY_BRIGHTNESS     0.55 // 0.1 dark ~ 1.6 bright
#define NL_ENTITY_EDGE_HIGHLIGHT 0.35 // [toggle] 0.0 no highlight ~ 1.6 bright highlight
